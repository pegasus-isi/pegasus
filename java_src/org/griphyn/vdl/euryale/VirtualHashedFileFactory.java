 ...
 * @version $Revision$
 */
public class VirtualHashedFileFactory extends HashedFileFactory {
     ...
     *     such.
     */
    public VirtualHashedFileFactory(File baseDirectory) throws IOException {
        super(baseDirectory);
    }
     ...
     *     such.
     */
    public VirtualHashedFileFactory(String baseDirectory) throws IOException {
        super(baseDirectory);
    }
     ...
     *     such.
     */
    public VirtualHashedFileFactory(File baseDirectory, int totalFiles) throws IOException {
     ...
     *     such.
     */
    public VirtualHashedFileFactory(String baseDirectory, int totalFiles) throws IOException {
        super(baseDirectory, totalFiles);
    }
