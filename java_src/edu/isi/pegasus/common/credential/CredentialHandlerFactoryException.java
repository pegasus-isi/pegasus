 ...
 * @version $Revision$
 */
public class CredentialHandlerFactoryException extends FactoryException {

    /** The default classname that is associated with the exception. */
    public static final String DEFAULT_NAME = "Credential Implementor";

    /**
     * Constructs a <code>CondorStyleFactoryException</code> with no detail message. The associated
     * classname is set to value specified by <code>DEFAULT_NAME</code>.
     *
     * @param msg the detailed message.
     * @see #DEFAULT_NAME
     */
    public CredentialHandlerFactoryException(String msg) {
        super(msg);
        mClassname = CredentialHandlerFactoryException.DEFAULT_NAME;
    }

    /**
     * Constructs a <code>CondorStyleFactoryException</code> with the specified detailed message.
     *
     ...
     *     like module name.
     */
    public CredentialHandlerFactoryException(String msg, String classname) {
        super(msg, classname);
    }

    /**
     * Constructs a <code>CondorStyleFactoryException</code> with the specified detailed message and
     ...
     * @see #DEFAULT_NAME
     */
    public CredentialHandlerFactoryException(String msg, Throwable cause) {
        super(msg, cause);
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public CredentialHandlerFactoryException(String msg, String classname, Throwable cause) {
        super(msg, cause);
