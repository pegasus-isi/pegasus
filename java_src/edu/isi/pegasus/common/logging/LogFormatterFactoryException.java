...
public class LogFormatterFactoryException extends FactoryException {
    ...
    /**
     * Constructs a <code>LogFormatterFactoryException</code> with no detail message. The associated
    ...
    /**
     * Constructs a <code>LogFormatterFactoryException</code> with the specified detailed message.
     *
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public LogFormatterFactoryException(String msg, String classname, Throwable cause) {
