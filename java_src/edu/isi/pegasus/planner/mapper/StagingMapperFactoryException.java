...
/**
 * Class to notify of failures while instantiating StagingMapper implementations.
 *
 * @author Karan Vahi
 * @version $Revision$
 */
public class StagingMapperFactoryException extends FactoryException {

    /** The default classname that is associated with the exception. */
    public static final String DEFAULT_NAME = "Staging Site Mapper";

    /**
     * Constructs a <code>StagingMapperFactoryException</code> with no detail message. The
     * associated classname is set to value specified by <code>DEFAULT_NAME</code>.
     *
     * @param msg the detailed message.
     * @see #DEFAULT_NAME
     */
    public StagingMapperFactoryException(String msg) {
        super(msg);
        mClassname = this.DEFAULT_NAME;
    }

    /**
     * Constructs a <code>StagingMapperFactoryException</code> with the specified detailed message.
     *
     ...
     *     like module name.
     */
    public StagingMapperFactoryException(String msg, String classname) {
        super(msg, classname);
    }
     ...
     * @see #DEFAULT_NAME
     */
    public StagingMapperFactoryException(String msg, Throwable cause) {
        super(msg, cause);
        mClassname = this.DEFAULT_NAME;
    }
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public StagingMapperFactoryException(String msg, String classname, Throwable cause) {
        super(msg, cause);
