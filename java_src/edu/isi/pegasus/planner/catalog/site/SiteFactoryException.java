...
public class SiteFactoryException extends FactoryException {
    ...
    /**
     * Constructs a <code>SiteFactoryException</code> with no detail message. The associated
    ...
    /**
     * Constructs a <code>SiteFactoryException</code> with the specified detailed message.
     *
    ...
    /**
     * Constructs a <code>SiteFactoryException</code> with the specified detailed message and a
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public SiteFactoryException(String msg, String classname, Throwable cause) {
