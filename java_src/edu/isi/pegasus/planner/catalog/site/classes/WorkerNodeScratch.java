...
/**
 * This data class describes the scratch area on a head node. The difference from the worker node
 * scratch is that it additionally has a worker shared directory that designates the shared
...
public class WorkerNodeScratch extends StorageType {
    ...
    public Object clone() {
        ...
        if (this.getWorkerSharedDirectory() != null) {
            obj.setWorkerSharedDirectory(
                    (WorkerSharedDirectory) this.getWorkerSharedDirectory().clone());
        }
