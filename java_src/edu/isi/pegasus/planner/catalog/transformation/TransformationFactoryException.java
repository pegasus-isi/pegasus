...
public class TransformationFactoryException extends FactoryException {
    ...
    /**
     * Constructs a <code>TransformationFactoryException</code> with no detail message. The
     * associated classname is set to value specified by <code>DEFAULT_NAME</code>.
     *
     * @param msg the detailed message.
     * @see #DEFAULT_NAME
     */
    public TransformationFactoryException(String msg) {
        super(msg);
        mClassname = this.DEFAULT_NAME;
    }

    /**
     * Constructs a <code>TransformationFactoryException</code> with the specified detailed message.
     *
     ...
     *     like module name.
     */
    public TransformationFactoryException(String msg, String classname) {
        super(msg, classname);
    }
     ...
     * @see #DEFAULT_NAME
     */
    public TransformationFactoryException(String msg, Throwable cause) {
        super(msg, cause);
        mClassname = this.DEFAULT_NAME;
    }
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public TransformationFactoryException(String msg, String classname, Throwable cause) {
