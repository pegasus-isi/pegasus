...
/**
 * An Adapter class that translates the new NMI based Architecture and OS specifications to VDS (
 * VDS era ) Arch and Os objects
 *
 * @author Karan Vahi
 * @version $Revision$
 */
public class NMI2VDSSysInfo {
     ...
     */
    public static VDSSysInfo nmiToVDSSysInfo(
            SysInfo.Architecture arch, SysInfo.OS os, String glibc) {
        VDSSysInfo result = new VDSSysInfo();
