...
/**
 * This class implements a replica catalog on top of a simple file which contains two or more
 * columns. It is neither transactionally safe, nor advised to use for production purposes in any
 * way. Multiple concurrent instances <b>will clobber</b> each other!
 *
 * <p>
 *
...
public class SimpleFile implements ReplicaCatalog {
        ...
        try {
            ...
            if (f.exists()) {
                ...
                while ((line = lnr.readLine()) != null) {
                    ...
                    try {
                        line = this.mDoVariableExpansion ? mVariableExpander.expand(line) : line;
    ...
    public boolean connect(Properties props) {
        ...
        m_readonly = Boolean.parse(props.getProperty(SimpleFile.READ_ONLY_KEY), false);
    ...
    public String lookup(String lfn, String handle) {
        ...
        for (Iterator i = c.iterator(); i.hasNext(); ) {
            ...
            if (pool == null && handle == null
                    || pool != null && handle != null && pool.equals(handle)) return rce.getPFN();
        }
        return null;
    }
     ...
     * matchAttributes to false, all entries having matching lfn pfn and site mapping to an entry in
     * the Map are deleted.
     *
     * @param x is a map from logical filename string to list of replica catalog entries.
            ...
            for (Map.Entry<String, Collection<ReplicaCatalogEntry>> entry : x.entrySet()) {
                ...
                for (ReplicaCatalogEntry rce : entry.getValue()) {
                    ...
                    result +=
                            this.delete(
                                    lfn,
                                    new ReplicaCatalogEntry(rce.getPFN(), rce.getResourceHandle()));
                }
            }
        }
        return result;
    ...
    private boolean hasMatchingAttr(ReplicaCatalogEntry rce, String name, Object value) {
        if (rce.hasAttribute(name)) return rce.getAttribute(name).equals(value);
