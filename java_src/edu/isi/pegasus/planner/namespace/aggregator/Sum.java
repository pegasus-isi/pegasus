...
/**
 * An implementation of the Aggregator interface that sums the profile values. In the case of either
 * of the profile values not valid integers, the default value is picked up.
 *
 * @author Karan Vahi
 * @version $Revision$
 */
public class Sum extends Abstract {
    ...
    public String compute(String oldValue, String newValue, String dflt) {
        return Integer.toString(parseInt(oldValue, dflt) + parseInt(newValue, dflt));
    }
}
