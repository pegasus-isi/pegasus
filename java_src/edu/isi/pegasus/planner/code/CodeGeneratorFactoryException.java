...
public class CodeGeneratorFactoryException extends FactoryException {
    ...
    /**
     * Constructs a <code>CodeGeneratorFactoryException</code> with no detail message. The
    ...
    /**
     * Constructs a <code>CodeGeneratorFactoryException</code> with the specified detailed message.
     *
     ...
     *     like module name.
     */
    public CodeGeneratorFactoryException(String msg, String classname) {
        super(msg, classname);
    }
     ...
     * @see #DEFAULT_NAME
     */
    public CodeGeneratorFactoryException(String msg, Throwable cause) {
        super(msg, cause);
        mClassname = this.DEFAULT_NAME;
    }
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public CodeGeneratorFactoryException(String msg, String classname, Throwable cause) {
        super(msg, cause);
