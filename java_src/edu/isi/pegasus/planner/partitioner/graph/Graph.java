...
/**
 * The interface for the Graph Class. It implements the GraphNodeContent interface. This allows us
 * to associate Graphs with the nodes in a Graph i.e. graph of graphs.
 *
 * @author Karan Vahi
 * @version $Revision$
 */
public interface Graph extends GraphNodeContent { // allows us to have graphs as nodes of a graph
