 ...
 * @version $Revision$
 */
public class ReplicaSelectorFactoryException extends FactoryException {

    /** The default classname that is associated with the exception. */
    public static final String DEFAULT_NAME = "Replica Selector";

    /**
     * Constructs a <code>ReplicaSelectorFactoryException</code> with no detail message. The
    ...
    /**
     * Constructs a <code>ReplicaSelectorFactoryException</code> with the specified detailed
     * message.
     *
    ...
    /**
     * Constructs a <code>ReplicaSelectorFactoryException</code> with the specified detailed message
