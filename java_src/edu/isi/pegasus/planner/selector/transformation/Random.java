...
public class Random extends TransformationSelector {
    ...
    /**
     * This method randomly selects one of the records from numerous valid Transformation Catalog
     * Entries returned by the TCMapper.
     *
    ...
    public List getTCEntry(List<TransformationCatalogEntry> tcEntries, String preferredSite) {
        ...
        List<TransformationCatalogEntry> selectFrom =
                preferredEntries.size() > 0 ? preferredEntries : tcEntries;
        ...
        TransformationCatalogEntry selected =
                selectFrom.size() > 1
                        ...
                        (TransformationCatalogEntry)
                                selectFrom.get(PegRandom.getInteger(selectFrom.size() - 1))
                        :
