 ...
 *
 * <pre>
 * PegasusAWSBatchException rce = null;
 * ... some loop code ... {
 *   ...
 ...
 */
public class PegasusAWSBatchException
...
// extends java.lang.Exception
{
    ...
    private PegasusAWSBatchException m_next_exception = null;

    /*
     * Constructs a <code>CatalogException</code> with no detail
     * message.
     */
    public PegasusAWSBatchException() {
        super();
     ...
     */
    public PegasusAWSBatchException(String s, Throwable cause) {
        super(s, cause);
        m_next_exception = null;
    }
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public PegasusAWSBatchException(Throwable cause) {
        super(cause);
        m_next_exception = null;
    }
     ...
     */
    public PegasusAWSBatchException getNextException() {
     ...
     */
    public void setNextException(PegasusAWSBatchException ex) {
        if (m_next_exception == null) {
            m_next_exception = ex;
        } else {
            PegasusAWSBatchException temp, rce = m_next_exception;
