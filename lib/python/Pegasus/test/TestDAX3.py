...
class TestMetadata(unittest.TestCase):
	def testConstructor(self):
		...
		self.assertRaises(ValueError, Metadata, None, "type", "value")
		self.assertRaises(ValueError, Metadata, "key", None, "value")
		self.assertRaises(ValueError, Metadata, "key", "type", None)
...
class TestPFN(unittest.TestCase):
	def testConstructor(self):
		...
		self.assertRaises(ValueError, PFN, None)
		self.assertRaises(ValueError, PFN, "url", None)
		self.assertRaises(ValueError, PFN, "")
		self.assertRaises(ValueError, PFN, "url", "")
...
class TestCatalogType(unittest.TestCase):
	def testConstructor(self):
		...
		self.assertRaises(ValueError, CatalogType, None)
		self.assertRaises(ValueError, CatalogType, "")
...
class TestFile(unittest.TestCase):
	...
	def testStdioXML(self):
		...
		self.assertRaises(ValueError, f.toStdioXML, "other")
...
class TestUse(unittest.TestCase):
	def testConstructor(self):
		...
		self.assertRaises(ValueError, Use, None)
	...
	def testXML(self):
		...
		a = Use("name", namespace="ns", version="version")
		self.assertEquals(str(a.toXML()), '<uses namespace="ns" name="name" version="version"/>')
		
		a = Use("name", version="version")
		self.assertEquals(str(a.toXML()), '<uses name="name" version="version"/>')
		
		a = Use("name")
		self.assertEquals(str(a.toXML()), '<uses name="name"/>')
		
		a = Use("name", version="version", transfer=True)
		self.assertEquals(str(a.toXML()), '<uses name="name" version="version" transfer="true"/>')
		
		a = Use("name", version="version", transfer=True, register=False)
		self.assertEquals(str(a.toXML()), '<uses name="name" version="version" register="false" transfer="true"/>')
		
		a = Use("name", link="link", register="true", transfer="true", 
				optional=True, namespace="ns", version="10", executable=True)
		self.assertEquals(str(a.toXML()), '<uses namespace="ns" name="name" version="10" link="link" register="true" transfer="true" optional="true" executable="true"/>')
		
	def testFile(self):
		"""Use should accept File as an argument"""
		f = File("filename")
		a = Use(f)
		self.assertEquals(str(a.toXML()), '<uses name="filename"/>')
		
	def testExecutable(self):
		"""Use should accept Executable as an argument"""
		e = Executable(name="exe", namespace="ns", version="1.0")
		a = Use(e)
		self.assertEquals(str(a.toXML()), '<uses namespace="ns" name="exe" version="1.0" executable="true"/>')
		
		a = Use(e, namespace="alt")
		self.assertEquals(str(a.toXML()), '<uses namespace="alt" name="exe" version="1.0" executable="true"/>')
		
		a = Use(e, version="alt")
		self.assertEquals(str(a.toXML()), '<uses namespace="ns" name="exe" version="alt" executable="true"/>')
		
		a = Use(e, register=True)
		self.assertEquals(str(a.toXML()), '<uses namespace="ns" name="exe" version="1.0" register="true" executable="true"/>')
...
class TestInvoke(unittest.TestCase):
	def testConstructor(self):
		...
		Invoke("when","what")
		self.assertRaises(ValueError, Invoke, "when", None)
...
class TestJob(unittest.TestCase):
	def testConstructor(self):
		...
		self.assertRaises(ValueError, Job, None)
		self.assertRaises(ValueError, Job, "")
	...
	def testArguments(self):
		...
		# Bad arguments
		e = Executable("exe")
		self.assertRaises(ValueError, j.addArguments, e)
...
class TestDAG(unittest.TestCase):
	def testConstructor(self):
		...
		self.assertRaises(ValueError, DAG, None)
		self.assertRaises(ValueError, DAG, "")
...
class TestDAX(unittest.TestCase):
	def testConstructor(self):
		...
		self.assertRaises(ValueError, DAX, None)
		self.assertRaises(ValueError, DAX, "")
...
class TestDependency(unittest.TestCase):
	def testConstructor(self):
		...
		# Id must be valid
		self.assertRaises(ValueError, Dependency, "a", None)
		self.assertRaises(ValueError, Dependency, None, "b")
		self.assertRaises(ValueError, Dependency, "a", "")
		self.assertRaises(ValueError, Dependency, "", "b")
		...
		a = Job("a")
		self.assertRaises(ValueError, Dependency, a, "ID01")
		self.assertRaises(ValueError, Dependency, "ID01", a)
		
		# No self-edges
		a = Job("a", id="ID01")
		self.assertRaises(ValueError, Dependency, a, a)
...
class TestADAG(unittest.TestCase):
	def testConstructor(self):
		...
		self.assertRaises(ValueError, ADAG, None)
		self.assertRaises(ValueError, ADAG, "")
		a = ADAG("name",10,1)
	...
	def testJobs(self):
		...
		a.addJob(dag)
		a.clearJobs()
		self.assertRaises(ValueError, a.addDAX, j)
		self.assertRaises(ValueError, a.addDAG, j)
		a.addDAX(dax)
		a.addDAG(dag)
		a.clearJobs()
		a.addJob(j)
