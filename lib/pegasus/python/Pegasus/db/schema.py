...
pg_ensemble_workflow = Table('ensemble_workflow', metadata,
    ...
    Column('event_cycle', Integer, nullable=False),
    Column('event_maxcycle', Integer, nullable=False),
    Column('event_timestamp', String(512)),
    Column('wf_uuid', String(36)),
    Column('submitdir', String(512)),
    Column('eventconfig', String(512)),
    Column('eventfile', String(512)),
    Column('eventdir', String(512)),
    Column('eventcontent', String(512)),
