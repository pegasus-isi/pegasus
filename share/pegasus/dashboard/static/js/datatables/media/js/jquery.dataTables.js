			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				if ( cOption == '<' )
				{
					...
					if ( cNext == "'" || cNext == '"' )
					{
						...
						/*
						 * Was: if ( sAttr == "H" )
						 * Changed to : if ( sAttr == "H" && oSettings.oFeatures.bFilter )
						 * Show header div only if filtering is enabled.
						 */
						if ( sAttr == "H" && oSettings.oFeatures.bFilter )
						{
						...
						/*
						 * Was: if ( sAttr == "F" )
						 * Changed to : else if ( sAttr == "F" && (oSettings.oFeatures.bPaginate || oSettings.oFeatures.bInfo) )
						 * Show footer div only if paging, or information display is enabled.
						 */
						else if ( sAttr == "F" && (oSettings.oFeatures.bPaginate || oSettings.oFeatures.bInfo) )
						{
