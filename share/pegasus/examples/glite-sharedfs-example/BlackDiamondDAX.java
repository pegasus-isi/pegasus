...
public class BlackDiamondDAX {
    ...
    private static ADAG Diamond(String pegasus_bin_dir) throws Exception {
        ...
        fa.addPhysicalFile("file://" + cwd + "/f.a", "local-pbs");
        dax.addFile(fa);
        ...
        preprocess.addPhysicalFile("file://" + pegasus_bin_dir + "/pegasus-keg", "local-pbs");
        ...
        findrange.addPhysicalFile("file://" + pegasus_bin_dir + "/pegasus-keg", "local-pbs");
        ...
        analyze.addPhysicalFile("file://" + pegasus_bin_dir + "/pegasus-keg", "local-pbs");
