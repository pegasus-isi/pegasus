Purpose
	...
	local SGE cluster  using the condor glite functionality in nonsharedfs mode
...
Setting SGE Parameters for jobs
       - Put the sge_local_submit_attributes.sh file distributed with
       ...
       - The profiles to set the SGE parameters for jobs are explained
         here
...
HOW TO RUN
    ...
    the sites.xml file will have a local-sge site that designates your
    cluster. 
