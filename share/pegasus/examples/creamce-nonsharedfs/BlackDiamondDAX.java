...
public class BlackDiamondDAX {
	...
	//String keg = "file:///data/scratch/vahi/work/creamce/test/creamce-condorio/pegasus-4.2.0-cvs/bin/pegasus-keg";
	String keg = "file://" + pegasus_bin_dir + "/pegasus-keg";
        ...
        preprocess.addPhysicalFile( keg, "local");
        ...
        findrange.addPhysicalFile( keg, "local");
        ...
        analyze.addPhysicalFile( keg, "local");
