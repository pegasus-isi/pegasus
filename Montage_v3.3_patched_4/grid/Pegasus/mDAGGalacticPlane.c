...
-------  ---------------  -------  -----------------------
1.1      Mats Rynge       18Jul11  Moved to DAX format 3.3
...
int main(int argc, char **argv)
{
   ...
   /***************************/
   /* tables for input images */
   /***************************/

   if(debug)
   {
      fprintf(fdebug, "Generating input images tables ...\n");
      fflush(fdebug);
   }
   ...
   fprintf(fdag, "  <!-- Part 1:  Definition of Jobs -->\n\n");
