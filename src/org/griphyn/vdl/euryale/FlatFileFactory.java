...
public class FlatFileFactory implements FileFactory
{
   ...
   * path string of the base directory for later perusal.
  ...
  /**
   * Returns the number of times the virtual constructor for structured
  ...
  /**
   * Constructs a virtual basename by removing the directory from a
