...
public class DAXParser extends DefaultHandler {
    ...
    // to print tags in hierarchy
    private int m_depth;

    // keep some of the objects so that they can be referred later.
    private ADAG m_adag;
    private Job m_job;
    ...
    // to indicate the parent element of the <filename> being processed.
    ...
    /**
     * The class constructor This function initializes the xerces parser, sets the classes that hold
     * the callback functions, and the features that enable schema validation.
     */
     ...
     * class instances that correspond to the DAX.
     *
     * @param daxURI is the URI for the DAX source.
     * @return an instance of class <code>ADAG</code>, which keeps the information about the LFNs,
     *     Jobs and Child-Parent relations specified in the DAX source.
     * @see org.griphyn.vdl.dax.ADAG
     */
    public ADAG parse(String daxURI) {
        try {
            m_adag = null;
            ...
            if (m_adag != null) {
                m_log.log("parser", 3, "*** SUCCESS ***");
                m_log.log("DAXparser", 3, "read " + m_adag.getSize() + " dags");
                return m_adag;
            }
     ...
     * @see org.griphyn.vdl.dax.ADAG
     */
    public ADAG parse(InputStream stream) {
        try {
            m_adag = null;
    ...
    public void startElement(
        ...
        createElementObject(qName, names, values);
    }
    ...
    public void createElementObject(String e, java.util.List names, java.util.List values)
        ...
        if (e.equals("adag")) {
            ...
            for (int i = 0; i < names.size(); ++i) {
                ...
                if (name.equals("name")) {
                    ...
                    m_adag.setName(value);
                } else if (name.equals("index")) {
                    this.log(e, name, value);
                    m_adag.setIndex(Integer.parseInt(value));
                } else if (name.equals("count")) {
                    this.log(e, name, value);
                    m_adag.setSize(Integer.parseInt(value));
                } else if (name.equals("version")) {
                    this.log(e, name, value);
                    m_adag.setVersion(value);
        ...
        if (e.equals("parent")) {
            ...
            m_adag.addChild(m_child, m_parent);
            return;
        }
