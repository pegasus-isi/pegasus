...
public class DAXParser extends DefaultHandler
{
   ...
   * This function initializes the xerces parser, sets the classes that 
   * hold the callback functions, and the features that enable schema
   * validation.
   */  
   ...
   * @return an instance of class <code>ADAG</code>, which keeps the
   * information about the LFNs, Jobs and Child-Parent relations specified
   * in the DAX source. 
