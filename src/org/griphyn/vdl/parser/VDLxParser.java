...
public class VDLxParser
{
   ...
   * in dontcare mode.
   *
   * @return usually an empty list. If not empty, it contains clashes in
   * insert, or old definitions in update mode. Please note that each
   * element is a single Definition, either Transformation or
   ...
   * @param callback is a handler for store callbacks that will take
