...
public class TCWrapper implements Wrapper
{
  ...
  /**
   * Connects the interface with the transformation catalog
  ...
  /**
   * Obtains all applications that bear the name and are installed at the
   * resource.
   * 
   ...
   * {@link org.griphyn.common.catalog.TransformationCatalogEntry TransformationCatalogEntry} with all matches.
   */
