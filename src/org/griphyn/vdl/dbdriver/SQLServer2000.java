...
/**
 * This class implements the driver API for the Microsoft SQL Server
 * 2000 database. Please note that due to the limited capabilities of
 * the Microsoft-provided free JDBC driver for SQL-Server, it will
 * <i>not</i> work as a database driver. However, if you have access to
...
public class SQLServer2000 extends DatabaseDriver
{
    ...
    throws SQLException, ClassNotFoundException
  {
    ...
    return this.connect( "com.microsoft.jdbc.sqlserver.SQLServerDriver",
			 url, info, tables );
