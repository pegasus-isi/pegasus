...
"VDS version " + Version.instance().toString() + linefeed );
    ...
    System.out.println(
"Usage: " + this.m_application + " [general] [-f] [-o dot] [dax]" );
...
" -f|--files        if present, show input and output files in graph." + linefeed +
" -d|--dv           if present, also show the DV names in graph." + linefeed +
" -o|--output dot   put the output into the file dot, defaults to stdout." + linefeed +
