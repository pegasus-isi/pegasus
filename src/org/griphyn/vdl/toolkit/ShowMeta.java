...
public class ShowMeta extends Toolkit 
{
  ...
  public void showUsage()
  {
    ...
    System.out.println( 
"$Id: ShowMeta.java,v 1.5 2005/08/16 16:25:31 griphyn Exp $" + linefeed +
"VDS version " + Version.instance().toString() + linefeed );

    System.out.println( 
"Usage: " + this.m_application + " [general] [-n ns] [-i id] [-v vs] [-a arg] [key [..]]" + linefeed +
"Or   : " + this.m_application + " [general] [-f lfn] [key [..]]" + linefeed );

    System.out.println( "General options: " + linefeed +
...
"Option groups 1 and 2 are mutually exclusive." + linefeed );
  ...
  public static void main(String[] args) 
  {
	...
	case 'V':
	  System.out.println( "$Id: ShowMeta.java,v 1.5 2005/08/16 16:25:31 griphyn Exp $" );
	...
	if ( opts.getOptind() == args.length-1 ) {
	  ...
	  for ( int i = opts.getOptind(); i < args.length; ++i ) {
	    ...
	    Tuple tuple = annotation.loadAnnotation(primary, secondary, classType, args[i]);
	    if (tuple != null)
	      System.out.println(tuple);
	  }
	}
