...
/**
 * This class is contains some excerpt from the getrusage call. Due to
...
public class Usage extends Invocation // implements Cloneable
{
   ...
   */
  public Usage( double utime, double stime,
		int minflt, int majflt,
		int nswap, int nsignals,
		int nvcsw, int nivcsw,
		int maxrss, int ixrss, int idrss, int isrss,
		int inblock, int outblock,
