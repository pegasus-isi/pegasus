...
public class TCQuery
    ...
    private void getTCXML() {
      ...
      out.append( "<transformations" );
      out.append( " xmlns=\"http://www.griphyn.org/vds/transformations\"" );
      out.append(
          " xsi:schemaLocation=\"http://www.griphyn.org/vds/transformations-schema " );
      out.append( " http://www.griphyn.org/vds/tc-1.0.xsd\"" );
