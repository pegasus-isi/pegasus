 ...
 * This interface follows a <a href="http://en.wikipedia.org/wiki/Builder_pattern">builder pattern</a>.
 *
...
public interface PPS {
     ...
     */
    public String beginWorkflowRefinementStep ( Refiner refiner, String refinementStepName, boolean firstStep) throws Exception;
