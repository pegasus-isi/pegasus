...
public class TCMap {
     ...
     * @param fqlfn String The fully qualified logical transformation name for which you want the map.
     ...
     * @param sitemap Map The sitemap that is to be stored. It is a hashmap with key
    ...
    public List getSiteList( String fqlfn, List sites ) {
       ...
       if ( mTCMap.containsKey( fqlfn ) ) {
           for ( Iterator i = (( Map ) mTCMap.get( fqlfn )).keySet().iterator();
               i.hasNext(); ) {
    ...
    public List getSiteTCEntries( String fqlfn, String siteid ) {
        ...
        if ( mTCMap.containsKey( fqlfn ) ) {
            ...
            if ( sitemap.containsKey( siteid ) ) {
                ...
                mLogger.log( "The TCMap does not contain the site \"" + siteid +
                    "\" for the transformation \"" + fqlfn + "\"",
                    LogManager.DEBUG_MESSAGE_LEVEL );
            }
        } else {
            mLogger.log( "The TCMap does not contain the transformation \"" +
                fqlfn + "\"",
                LogManager.DEBUG_MESSAGE_LEVEL );
        }
        return tcentries;
     ...
     *
     * @return a map indexed by site names. Each value is a collection of
     * <code>TransformationCatalogEntry</code> objects. Returns null in case
     ...
     * @return boolean
     */
    public boolean setSiteTCEntries( String fqlfn, String siteid,
