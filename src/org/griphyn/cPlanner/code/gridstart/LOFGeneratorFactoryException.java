...
/**
 * Class to notify of failures while instantiating LOFGenerator implementations.
 *
 * @author Karan Vahi
 * @version $Revision$
 */

public class LOFGeneratorFactoryException extends FactoryException {

    /**
     * The default classname that is associated with the exception.
     */
    public static final String DEFAULT_NAME = "LOFGenerator";


    /**
     * Constructs a <code>LOFGeneratorFactoryException</code> with no detail
     ...
     * @see #DEFAULT_NAME
     */
    public LOFGeneratorFactoryException( String msg ) {
        super( msg );
        mClassname = this.DEFAULT_NAME;
    }

    /**
     * Constructs a <code>LOFGeneratorFactoryException</code> with the specified detailed
     * message.
     *
     ...
     */
    public LOFGeneratorFactoryException(String msg, String classname) {
        super( msg , classname );
    }


    /**
     * Constructs a <code>LOFGeneratorFactoryException</code> with the
     ...
     * @see #DEFAULT_NAME
     */
    public LOFGeneratorFactoryException(String msg, Throwable cause) {
        super(msg, cause);
        mClassname = this.DEFAULT_NAME;
    }
