 ...
 * @version $Revision$
 */
public class DefaultLogger extends LogManager{
    ...
    protected DefaultLogger(){
        ...
        DefaultLogger.mFormatter = new Currently( "yyyy.MM.dd HH:mm:ss.SSS zzz: " );
     ...
     */
     private void log(String message, int level, boolean comp){
         ...
         if( (type & mMask) != 0x0 ){
             ...
             writer.print(DefaultLogger.mFormatter.now());
...
//                     mMsgStack.push(message);
     ...
     public String getTimeStamp(){
         String st =  DefaultLogger.mFormatter.now();
