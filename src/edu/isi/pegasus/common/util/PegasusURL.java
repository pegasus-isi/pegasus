 ...
 *
 * <p>The class parses the PegasusURL into 3 main components - protocol - hostname - path
 *
 * <p>The class is consistent with the PegasusURL parsing scheme used in pegasus-transfer.
 *
 * @author Karan Vahi
 * @author Mats Rynge
 */
public class PegasusURL {
    ...
    /**
     * Returns the url prefix associated with the PegasusURL. The PegasusURL prefix is the part of
     * the PegasusURL composed of protocol and the hostname
     *
     * <p>For example PegasusURL prefix for
     *
     * <pre>
    ...
    public String getURLPrefix() {
        ...
        prefix.append(this.getProtocol()).append("://").append(this.getHost());
    ...
    /**
     * Matches if two Pegasus URL objects are the same If the both URL's are file URL's then it does
     * a canonical match on the path component , else just a string match
     *
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                new PegasusURL(url)
                        .equals(
                                new PegasusURL(
                                        "gsiftp://dataserver.phys.uwm.edu/dest.php?x:=griphyn_test//ligodemo_output/")));
