...
/**
 * A utility class that has convenience methods to execute a command and retrive
...
public class ShellCommand {
    ...
    public int execute(String command, String args){
        ...
        try{
            ...
            exitcode = p.waitFor();
            if( exitcode != 0){
                mLogger.log("Command " + execCommand + " exited with status " + exitcode,
            ...
            mLogger.log("IOException while executng command ", ioe,
    ...
    /**
     * An inner class, that implements the StreamGobblerCallback to store the output
     * returned
     *
     */
