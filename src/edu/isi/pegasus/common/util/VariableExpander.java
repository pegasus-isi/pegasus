...
public class VariableExpander {
    ...
    /**
     * The default constructor, which intializes the values from
     * the System environment variables, and has case sensitivity turned off.
     */
...
class CaseSensitiveStrLookup<V> extends StrLookup<V> {
    ...
    public String lookup(final String key) {
        String casedKey = mCaseSensitive ? key : key.toLowerCase(); //lowercase the key you're looking for
        if (mMap == null) {
            return null;
        }
