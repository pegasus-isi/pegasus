...
public class LogFormatterFactory {
     ...
     * @see #DEFAULT_PACKAGE_NAME
     */
    public static LogFormatter loadInstance( PegasusProperties properties ) throws
        LogFormatterFactoryException {
        ...
        formatImplementor = ( formatImplementor.indexOf('.') == -1) ?
     ...
     * @see #DEFAULT_PACKAGE_NAME
     */
    public  static LogFormatter loadInstance( String implementor ) throws
        LogFormatterFactoryException{
        ...
        try{
            ...
            /* prepend the package name if required */
            implementor = ( implementor.indexOf('.') == -1) ?
                //pick up from the default package
            ...
            throw new LogFormatterFactoryException( "Unable to instantiate Log Formatter ",
                                            implementor,
                                            e );
        }
