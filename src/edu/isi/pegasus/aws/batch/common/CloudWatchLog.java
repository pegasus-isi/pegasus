...
public class CloudWatchLog {
    ...
    public static final String TASK_STDERR_SEPARATOR =
            "########################[AWS BATCH] TASK STDERR ########################";
    ...
    public Tuple<File, File> retrieve(String awsJobID, String summary) {
        DescribeJobsRequest jobsRequest = DescribeJobsRequest.builder().jobs(awsJobID).build();
     ...
     * @return a Tuple containing the stdout and stderr files to which it is retrieved
     */
    public Tuple<File, File> retrieve(
            String jobName, String logGroup, String streamName, String summary) {
        mLogger.info(
                "Retrieving log for "
                        + jobName
                        + " for log group "
