 ...
 * @version $Revision$
 */
public class PartitionerFactoryException extends FactoryException {

    /** The default classname that is associated with the exception. */
    public static final String DEFAULT_NAME = "Partitioner";

    /**
     * Constructs a <code>PartitionerFactoryException</code> with no detail message. The associated
     * classname is set to value specified by <code>DEFAULT_NAME</code>.
     *
     * @param msg the detailed message.
     * @see #DEFAULT_NAME
     */
    public PartitionerFactoryException(String msg) {
        super(msg);
        mClassname = this.DEFAULT_NAME;
    }

    /**
     * Constructs a <code>PartitionerFactoryException</code> with the specified detailed message.
     *
     ...
     *     like module name.
     */
    public PartitionerFactoryException(String msg, String classname) {
        super(msg, classname);
    }

    /**
     * Constructs a <code>PartitionerFactoryException</code> with the specified detailed message and
     ...
     * @see #DEFAULT_NAME
     */
    public PartitionerFactoryException(String msg, Throwable cause) {
        super(msg, cause);
        mClassname = this.DEFAULT_NAME;
    }
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public PartitionerFactoryException(String msg, String classname, Throwable cause) {
