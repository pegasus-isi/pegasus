...
public interface Bag {
    ...
    /**
     * Returns true if the namespace contains a mapping for the specified key.More formally, returns
     * true if and only if this map contains at a mapping for a key k such that (key==null ? k==null
