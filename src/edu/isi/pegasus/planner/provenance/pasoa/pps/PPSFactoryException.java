...
public class PPSFactoryException extends FactoryException {
    ...
    /**
     * Constructs a <code>PPSFactoryException</code> with no detail message. The associated
    ...
    /**
     * Constructs a <code>PPSFactoryException</code> with the specified detailed message.
     *
    ...
    /**
     * Constructs a <code>PPSFactoryException</code> with the specified detailed message and a
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public PPSFactoryException(String msg, String classname, Throwable cause) {
