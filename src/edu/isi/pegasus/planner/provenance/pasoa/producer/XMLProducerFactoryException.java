...
public class XMLProducerFactoryException extends FactoryException {
    ...
    /**
     * Constructs a <code>XMLProducerFactoryException</code> with no detail message. The associated
    ...
    /**
     * Constructs a <code>XMLProducerFactoryException</code> with the specified detailed message.
     *
    ...
    /**
     * Constructs a <code>XMLProducerFactoryException</code> with the specified detailed message and
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public XMLProducerFactoryException(String msg, String classname, Throwable cause) {
