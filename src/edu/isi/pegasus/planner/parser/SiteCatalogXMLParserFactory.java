...
public class SiteCatalogXMLParserFactory {
     ...
     *
     * @exception SiteCatalogXMLParserFactoryException that nests any error that
    ...
    public static SiteCatalogXMLParser loadSiteCatalogXMLParser( PegasusBag bag,  String file , List<String> sites ) throws SiteCatalogXMLParserFactoryException{
        ...
        try{
            ...
            if( m.containsKey( "version" ) && (schemaVersion = (String)m.get( "version" )) != null  ){
                    logger.log( "Site Catalog Schema Version as determined from catalog file " + schemaVersion,
            ...
            if( schemaVersion == null && schemaLocation != null ){
                logger.log( "Guessing schema version from schema location " + schemaLocation,
                            LogManager.DEBUG_MESSAGE_LEVEL );
                //split on whitespace
                ...
                if( schema.startsWith( "sc-" )  && schema.endsWith( ".xsd" ) ){
                    schemaVersion = schema.substring( schema.indexOf( "sc-" ) + 3,
                                                   schema.lastIndexOf(".xsd") );

                    
                    logger.log( "Site Catalog XML Version as determined from schema location " + schemaVersion,
                        LogManager.DEBUG_MESSAGE_LEVEL );
        ...
        if( schemaVersion != null ){
            ...
            if( numericValue < SiteCatalogXMLParserFactory.SC_VERSION_2_0_0 ){
                //log error
                throw new SiteCatalogXMLParserFactoryException( "Site Catalog Schema Version2 is no longer supported" );
            }
        ...
        logger.log( "Site Catalog Parser Class to be loaded is " + scClass,
     ...
     * @see #DEFAULT_CALLBACK_PACKAGE_NAME
     */
    private static final SiteCatalogXMLParser loadSiteCatalogParser( String classname, PegasusBag bag, List<String> sites  ){
        ...
        try{
            ...
            throw new SiteCatalogXMLParserFactoryException( "Unable to instantiate SiteCatalogXMLParser class ",
                                                    classname, e);
        }
        return parser;
    }
    ...
    public static Map getMetadata( PegasusBag bag, String file ){
        ...
        LogManager logger = bag.getLogger();
        if( logger != null ){
            logger.log( "Retrieving Metadata from the file " + file ,
                        LogManager.DEBUG_MESSAGE_LEVEL );
        }
 ...
 * of an element in a XML Document. It used to get the metadata in the root element.
 *
 * @author Karan Vahi
 */
    ...
    public void startParser(String file) {
        ...
        try{
            ...
            String message = (mLocator == null) ?
                           ...
                           "SiteCatalogXMLMetadataParser While parsing file " + mLocator.getSystemId() +
