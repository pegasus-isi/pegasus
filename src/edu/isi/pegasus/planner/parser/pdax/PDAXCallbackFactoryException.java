...
public class PDAXCallbackFactoryException extends FactoryException {
    ...
    /**
     * Constructs a <code>PDAXCallbackFactoryException</code> with no detail message. The associated
    ...
    /**
     * Constructs a <code>PDAXCallbackFactoryException</code> with the specified detailed message.
     *
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public PDAXCallbackFactoryException(String msg, String classname, Throwable cause) {
        super(msg, cause);
