 ...
 * @author Karan Vahi
 */
public class TransformationCatalogReservedWord implements Token {
    ...
    public static java.util.Map<String, TransformationCatalogReservedWord> symbolTable() {
        if (mSymbolTable == null) {
            ...
            mSymbolTable.put(
                    "tr",
                    new TransformationCatalogReservedWord(
            ...
            mSymbolTable.put(
                    "metadata",
                    new TransformationCatalogReservedWord(
                            TransformationCatalogReservedWord.METADATA));
            mSymbolTable.put(
                    "profile",
                    new TransformationCatalogReservedWord(
            ...
            mSymbolTable.put(
                    "osrelease",
                    new TransformationCatalogReservedWord(
                            TransformationCatalogReservedWord.OSRELEASE));
            mSymbolTable.put(
                    "osversion",
                    new TransformationCatalogReservedWord(
                            TransformationCatalogReservedWord.OSVERSION));
            mSymbolTable.put(
                    "type",
            ...
            mSymbolTable.put(
                    "container",
                    new TransformationCatalogReservedWord(
                            TransformationCatalogReservedWord.CONTAINER));
            mSymbolTable.put(
                    "cont",
            ...
            mSymbolTable.put(
                    "image_site",
                    new TransformationCatalogReservedWord(
                            TransformationCatalogReservedWord.IMAGE_SITE));
            mSymbolTable.put(
                    "dockerfile",
                    new TransformationCatalogReservedWord(
                            TransformationCatalogReservedWord.DOCKERFILE));
            mSymbolTable.put(
                    "mount",
                    new TransformationCatalogReservedWord(
                            TransformationCatalogReservedWord.MOUNT_POINT));
        }
    ...
    /**
     * Initializes an instance of a reserved word token. The constructor is unreachable from the
     * outside. Use symbol table lookups to obtain reserved word tokens.
     *
    ...
    public String toString() {
        // kludgy?
        String result = null;
        for (Map.Entry<String, TransformationCatalogReservedWord> entry :
                TransformationCatalogReservedWord.symbolTable().entrySet()) {
