...
public class WorkflowMetrics extends Data implements Cloneable{
     ...
     */
    @SerializedName("dax_input_files") @Expose private int mNumInputFiles;
    
    /**
     * The number of intermediate used by the workflow.
     */
    @SerializedName("dax_inter_files") @Expose private int mNumIntermediateFiles;
    
    /**
     * The number of output files generated by the workflow.
     */
    @SerializedName("dax_output_files") @Expose private int mNumOutputFiles;
    
    /**
     * The total number of output files referred in the DAX
     */
    @SerializedName("dax_total_files") @Expose private int mNumTotalFiles;
