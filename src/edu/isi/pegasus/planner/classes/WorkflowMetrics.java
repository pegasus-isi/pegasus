...
public class WorkflowMetrics extends Data implements Cloneable{
     ...
     */
    @SerializedName("input_files") @Expose private int mNumInputFiles;
    
    /**
     * The number of intermediate used by the workflow.
     */
    @SerializedName("intermediate_files") @Expose private int mNumIntermediateFiles;
    
    
    /**
     * The number of output files generated by the workflow.
     */
    @SerializedName("output_files") @Expose private int mNumOutputFiles;
