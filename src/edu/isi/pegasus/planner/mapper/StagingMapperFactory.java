...
/**
 * A factory class to load the appropriate type of Directory StagingMapper specified by the user at
...
public class StagingMapperFactory {
    ...
    public static final String DEFAULT_PACKAGE_NAME = "edu.isi.pegasus.planner.mapper.staging";
     ...
     * @throws StagingMapperFactoryException that chains any error that might occur during the
     *     instantiation
     * @see #DEFAULT_PACKAGE_NAME
     * @see #HASHED_STAGING_MAPPER
     */
    public static StagingMapper loadInstance(PegasusBag bag) throws StagingMapperFactoryException {
        ...
        try {
            ...
            String value =
                    properties.getProperty(PegasusConfiguration.PEGASUS_CONFIGURATION_PROPERTY_KEY);
            ...
            className = (className == null || className.trim().length() < 2) ? dfault : className;
            ...
            Properties mapperProps =
                    properties.matchingSubset(StagingMapper.PROPERTY_PREFIX, false);
            ...
            throw new StagingMapperFactoryException("Instantiating Staging Mapper ", className, e);
        }
