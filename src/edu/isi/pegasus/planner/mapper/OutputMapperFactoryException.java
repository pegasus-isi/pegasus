...
public class OutputMapperFactoryException extends FactoryException {
    ...
    /**
     * Constructs a <code>OutputMapperFactoryException</code> with no detail message. The associated
    ...
    /**
     * Constructs a <code>OutputMapperFactoryException</code> with the specified detailed message.
     *
     ...
     *     like module name.
     */
    public OutputMapperFactoryException(String msg, String classname) {
        super(msg, classname);
    }
     ...
     * @see #DEFAULT_NAME
     */
    public OutputMapperFactoryException(String msg, Throwable cause) {
        super(msg, cause);
        mClassname = this.DEFAULT_NAME;
    }
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public OutputMapperFactoryException(String msg, String classname, Throwable cause) {
        super(msg, cause);
