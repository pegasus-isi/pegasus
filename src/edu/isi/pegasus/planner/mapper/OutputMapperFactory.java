...
public class OutputMapperFactory {
     ...
     * that is required by the mapper.
     *
     ...
     *
     * @exception TransferOutputMapperException that nests any error that
     *            might occur during the instantiation.
     *
     * @see #DEFAULT_PACKAGE_NAME
     */
    public static OutputMapper loadInstance( ADag dag,
                                        PegasusBag bag )
     ...
     * @return the instance of the class implementing this interface.
     *
     * @exception OutputMapperFactoryException that nests any error that
     *            might occur during the instantiation.
     *
     * @see #DEFAULT_PACKAGE_NAME
     */
    public static OutputMapper loadInstance( String className,
                                            PegasusBag bag,
                                            ADag dag )
        throws OutputMapperFactoryException{
        ...
        try{
            ...
            throw new OutputMapperFactoryException("Instantiating Output Mapper",
                                                      className,
                                                      e);
        }
