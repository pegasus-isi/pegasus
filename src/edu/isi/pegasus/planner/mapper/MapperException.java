...
import edu.isi.pegasus.planner.cluster.*;

/**
 * The baseclass of the exception that is thrown by all Mappers. It is a checked exception.
 *
 * @author Karan Vahi
 * @version $Revision$
 */
public class MapperException extends RuntimeException {
    ...
    /** Constructs a <code>MapperException</code> with no detail message. */
    ...
    /**
     * Constructs a <code>MapperException</code> with the specified just a cause.
     *
     * @param cause is the cause (which is saved for later retrieval by the {@link
     *     java.lang.Throwable#getCause()} method). A <code>null</code> value is permitted, and
     *     indicates that the cause is nonexistent or unknown.
