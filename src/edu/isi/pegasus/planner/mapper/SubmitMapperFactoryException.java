...
public class SubmitMapperFactoryException extends FactoryException {
    ...
    /**
     * Constructs a <code>CreatorFactoryException</code> with no detail message. The associated
    ...
    /**
     * Constructs a <code>CreatorFactoryException</code> with the specified detailed message.
     *
    ...
    /**
     * Constructs a <code>CreatorFactoryException</code> with the specified detailed message and a
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public SubmitMapperFactoryException(String msg, String classname, Throwable cause) {
        super(msg, cause);
