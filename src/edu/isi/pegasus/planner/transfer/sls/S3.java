...
import edu.isi.pegasus.planner.engine.CreateDirectory;
import edu.isi.pegasus.planner.engine.createdir.Implementation;
...
//    protected PoolInfoProvider mSiteHandle;
     ...
     */
    protected edu.isi.pegasus.planner.transfer.implementation.S3Cmd mS3Transfer;
     ...
     */
    private edu.isi.pegasus.planner.engine.createdir.S3 mS3CreateDirImpl;
    ...
    public void initialize( PegasusBag bag ) {
        ...
        mS3Transfer = new edu.isi.pegasus.planner.transfer.implementation.S3Cmd( bag );
        ...
        if ( !( createDirImpl instanceof edu.isi.pegasus.planner.engine.createdir.S3 )){
            throw new RuntimeException( "Only S3 Create Dir implementation can be used with S3 SLS" );
        }
        mS3CreateDirImpl = (edu.isi.pegasus.planner.engine.createdir.S3 )createDirImpl;
