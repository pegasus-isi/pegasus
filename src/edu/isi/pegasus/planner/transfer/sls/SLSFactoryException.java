...
public class SLSFactoryException extends FactoryException {
    ...
    /**
     * Constructs a <code>SLSFactoryException</code> with no detail message. The associated
    ...
    /**
     * Constructs a <code>SLSFactoryException</code> with the specified detailed message.
     *
    ...
    /**
     * Constructs a <code>SLSFactoryException</code> with the specified detailed message and a
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public SLSFactoryException(String msg, String classname, Throwable cause) {
        super(msg, cause);
