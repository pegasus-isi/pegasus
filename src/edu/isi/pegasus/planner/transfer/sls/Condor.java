...
//        mSiteHandle = bag.getHandleToSiteCatalog();
    ...
    public boolean modifyJobForWorkerNodeExecution( Job job, 
        ...
        if( style == null || 
                !( style.equals( Pegasus.CONDOR_STYLE ) || style.equals( Pegasus.GLIDEIN_STYLE ) ||
                      style.equals( Pegasus.CONDORC_STYLE ) || style.equals( Pegasus.CREAMCE_STYLE )

                  ) ){
            mLogger.log( "Invalid style " + style + " for the job " + job.getName(),
