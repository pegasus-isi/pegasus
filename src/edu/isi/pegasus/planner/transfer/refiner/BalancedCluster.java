 ...
 * The files are distributed in a round robin manner across the stagein 
 * and stageout jobs. Currently it is per workflow for the stage-in while
 * for stageout it is per level of the workflow.
 *
 * @author Karan Vahi
 * @version $Revision$
 */
...
public class BalancedCluster extends Basic {
    ...
    protected class PoolTransfer{
      ...
      /**
       ...
       /**
        * Adds a single <code>FileTransfer</code> objects to the
        * appropriate TransferContainer. The collection is added to a single
        * TransferContainer, and the pointer is then updated to the next container.
        *
        * @param file
