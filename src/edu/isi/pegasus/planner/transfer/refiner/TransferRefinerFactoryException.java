...
public class TransferRefinerFactoryException extends FactoryException {
    ...
    public static final String DEFAULT_NAME = "Transfer Refiner";

    /**
     * Constructs a <code>TransferRefinerFactoryException</code> with no detail message. The
     * associated classname is set to value specified by <code>DEFAULT_NAME</code>.
     *
     * @param msg the detailed message.
     * @see #DEFAULT_NAME
     */
    public TransferRefinerFactoryException(String msg) {
        super(msg);
        mClassname = this.DEFAULT_NAME;
    }

    /**
     * Constructs a <code>TransferRefinerFactoryException</code> with the specified detailed
     * message.
     *
     ...
     *     like module name.
     */
    public TransferRefinerFactoryException(String msg, String classname) {
        super(msg, classname);
    }

    /**
     * Constructs a <code>TransferRefinerFactoryException</code> with the specified detailed message
     ...
     * @see #DEFAULT_NAME
     */
    public TransferRefinerFactoryException(String msg, Throwable cause) {
        super(msg, cause);
        mClassname = this.DEFAULT_NAME;
    }
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public TransferRefinerFactoryException(String msg, String classname, Throwable cause) {
        super(msg, cause);
