...
public interface Refiner
    extends edu.isi.pegasus.planner.engine.Refiner {//need to extend it for the PASOA integration
    ...
    /**
     * The prefix for the jobs that symlink against existing input data on a 
     * compute site.
     */
