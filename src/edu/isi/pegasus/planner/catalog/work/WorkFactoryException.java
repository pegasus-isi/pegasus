 ...
 * @version $Revision: 50 $
 */
public class WorkFactoryException extends FactoryException {

    /** The default classname that is associated with the exception. */
    public static final String DEFAULT_NAME = "Work Catalog";

    /**
     * Constructs a <code>WorkFactoryException</code> with no detail message. The associated
     * classname is set to value specified by <code>DEFAULT_NAME</code>.
     *
     * @param msg the detailed message.
     * @see #DEFAULT_NAME
     */
    public WorkFactoryException(String msg) {
        super(msg);
        mClassname = this.DEFAULT_NAME;
    }

    /**
     * Constructs a <code>WorkFactoryException</code> with the specified detailed message.
     *
     ...
     *     like module name.
     */
    public WorkFactoryException(String msg, String classname) {
        super(msg, classname);
    }

    /**
     * Constructs a <code>WorkFactoryException</code> with the specified detailed message and a
     ...
     * @see #DEFAULT_NAME
     */
    public WorkFactoryException(String msg, Throwable cause) {
        super(msg, cause);
        mClassname = this.DEFAULT_NAME;
    }
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public WorkFactoryException(String msg, String classname, Throwable cause) {
