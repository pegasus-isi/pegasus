...
public class Directory implements ReplicaCatalog {
     ...
     * @return the (first) matching physical directory, or
     ...
     *
     * @param constraint is a constraint for the logical directory only. It
    ...
    public int delete(String lfn, String pfn) {
         throw new java.lang.UnsupportedOperationException("delete( String, String ) not implemented as yet");
    }
     ...
     *
     * @param x                is a map from logical directory string to list of
    ...
    public int delete(String lfn, String name, Object value) {
         throw new java.lang.UnsupportedOperationException("delete( String, String, Object) not implemented as yet");
    }
