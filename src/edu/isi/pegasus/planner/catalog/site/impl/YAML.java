...
/**
 * An implementation of the Site Catalog interface that is backed up by YAML..
...
public class YAML implements SiteCatalog {
    ...
    public boolean connect( Properties props ) throws SiteCatalogException{
        ...
        throw new SiteCatalogException( "Please specify the property " +  SiteCatalog.c_prefix + ".file" +
                " in your properties file or have the file " + YAML.DEFAULT_SITE_CATALOG_BASENAME + " in the current working directory "  );
    } 
