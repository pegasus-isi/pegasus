...
public class CreateSampleSiteCatalog {
    ...
    public HeadNodeFS createHeadNodeFS() {
        ...
        hscratchShared.setInternalMountPoint(
                new InternalMountPoint("/shared-scratch", "50G", "100G"));
        ...
        hstorageLocal.setInternalMountPoint(
                new InternalMountPoint("/local-storage", "30G", "100G"));
        ...
        hstorageShared.setInternalMountPoint(
                new InternalMountPoint("/shared-storage", "50G", "100G"));
    ...
    public WorkerNodeFS createWorkerNodeFS() {
        ...
        wscratchShared.setInternalMountPoint(
                new InternalMountPoint("/shared-scratch", "50G", "100G"));
        ...
        wstorageShared.setInternalMountPoint(
                new InternalMountPoint("/shared-storage", "50G", "100G"));
