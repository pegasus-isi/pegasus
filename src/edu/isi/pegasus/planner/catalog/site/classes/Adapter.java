...
public class Adapter {
    ...
    /**
     * An adapter method that converts the <code>SiteCatalogEntry3</code> object to
     * <code>SiteCatalogEntry</code> object. For the directories, the following
    ...
    /**
     * An adapter method that converts the <code>SiteCatalogEntry</code> object to
     * <code>SiteCatalogEntry3</code> object. For the directories, the following
     * mapping is followed.
     *
     * <pre>
     ...
     * </pre>
     *
     * Note that the adapter method while converting does
     * not clone the members. The user need to call on the returned object if they
     * want a cloned copy.
     *
