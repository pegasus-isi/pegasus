 ...
 * @version $Revision$
 */
public class SiteSelectorFactoryException extends FactoryException {

    /** The default classname that is associated with the exception. */
    public static final String DEFAULT_NAME = "Site Selector";

    /**
     * Constructs a <code>SiteSelectorFactoryException</code> with no detail message. The associated
     * classname is set to value specified by <code>DEFAULT_NAME</code>.
     *
     * @param msg the detailed message.
     * @see #DEFAULT_NAME
     */
    public SiteSelectorFactoryException(String msg) {
        super(msg);
        mClassname = this.DEFAULT_NAME;
    }

    /**
     * Constructs a <code>SiteSelectorFactoryException</code> with the specified detailed message.
     *
     ...
     *     like module name.
     */
    public SiteSelectorFactoryException(String msg, String classname) {
        super(msg, classname);
    }
     ...
     * @see #DEFAULT_NAME
     */
    public SiteSelectorFactoryException(String msg, Throwable cause) {
        super(msg, cause);
        mClassname = this.DEFAULT_NAME;
    }
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public SiteSelectorFactoryException(String msg, String classname, Throwable cause) {
        super(msg, cause);
