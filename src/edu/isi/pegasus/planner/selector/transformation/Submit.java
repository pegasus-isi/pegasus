...
public class Submit extends TransformationSelector {
    ...
    /**
     * This method returns a list of TransformationCatalogEntry objects of type STATIC_BINARY and
     * only available on the Submit machine( "local" site).
     *
     * @param tcentries the original list of TransformationCatalogEntry objects on which the
     *     selector needs to run.
