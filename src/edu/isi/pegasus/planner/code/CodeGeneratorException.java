...
public class CodeGeneratorException extends Exception {
    ...
    /** Constructs a <code>CodeGeneratorException</code> with no detail message. */
    public CodeGeneratorException() {
        super();
    }

    /**
     * Constructs a <code>CodeGeneratorException</code> with the specified detailed message.
     *
    ...
    /**
     * Constructs a <code>CodeGeneratorException</code> with the specified detailed message and a
     * cause.
     *
     * @param message is the detailled message.
    ...
    /**
     * Constructs a <code>CodeGeneratorException</code> with the specified just a cause.
     *
     * @param cause is the cause (which is saved for later retrieval by the {@link
     *     java.lang.Throwable#getCause()} method). A <code>null</code> value is permitted, and
     *     indicates that the cause is nonexistent or unknown.
