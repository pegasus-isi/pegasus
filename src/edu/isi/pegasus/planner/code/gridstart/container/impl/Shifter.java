...
public class Shifter extends Abstract{
    ...
    protected String constructJobLaunchScriptInContainer( Job job, String scriptName ) {
        ...
        sb.append( "EOF\n" );
        sb.append( "container_env " ).append( Shifter.CONTAINER_WORKING_DIRECTORY ).append( " >> ").append( scriptName ).append( "\n" );
        ...
        if( job instanceof AggregatedJob ){
            try{
                ...
                throw new RuntimeException( "[Pegasus-Lite] Error while wrapping job with Shifter " + job.getID(), ioe );
            }
        }
        else{
    ...
    protected static String constructContainerWorkerPackagePreamble() {
        ...
        sb.append( "pegasus_lite_work_dir=" ).append( Shifter.CONTAINER_WORKING_DIRECTORY ).append( "\n" );
