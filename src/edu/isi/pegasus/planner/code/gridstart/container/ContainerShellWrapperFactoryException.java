...
/**
 * Class to notify of failures while instantiating Container Shell Wrapper implementations.
 *
 * @author Karan Vahi
 * @version $Revision$
 */
public class ContainerShellWrapperFactoryException extends FactoryException {

    /** The default classname that is associated with the exception. */
    public static final String DEFAULT_NAME = "Container Shell Wrapper";

    /**
     * Constructs a <code>ContainerShellWrapperFactoryException</code> with no detail message. The
     * associated classname is set to value specified by <code>DEFAULT_NAME</code>.
     *
     * @param msg the detailed message.
     * @see #DEFAULT_NAME
     */
    public ContainerShellWrapperFactoryException(String msg) {
        super(msg);
        mClassname = this.DEFAULT_NAME;
    }

    /**
     * Constructs a <code>ContainerShellWrapperFactoryException</code> with the specified detailed
     * message.
     *
     ...
     *     like module name.
     */
    public ContainerShellWrapperFactoryException(String msg, String classname) {
        super(msg, classname);
    }
     ...
     * @see #DEFAULT_NAME
     */
    public ContainerShellWrapperFactoryException(String msg, Throwable cause) {
        super(msg, cause);
        mClassname = this.DEFAULT_NAME;
    }
     ...
     *     indicates that the cause is nonexistent or unknown.
     */
    public ContainerShellWrapperFactoryException(String msg, String classname, Throwable cause) {
        super(msg, cause);
