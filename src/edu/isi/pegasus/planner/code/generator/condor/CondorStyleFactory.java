...
public class CondorStyleFactory {
    ...
    private static Map<String, String> implementingClassNameTable() {
        if (mImplementingClassNameTable == null) {
            ...
            mImplementingClassNameTable.put(
                    Pegasus.GLIDEIN_STYLE, GLIDEIN_STYLE_IMPLEMENTING_CLASS);
            mImplementingClassNameTable.put(
                    Pegasus.GLIDEINWMS_STYLE, GLIDEINWMS_STYLE_IMPLEMENTING_CLASS);
            ...
            mImplementingClassNameTable.put(
                    Pegasus.CONDORC_STYLE, CONDORC_STYLE_IMPLEMENTING_CLASS);
            mImplementingClassNameTable.put(
    ...
    /**
     * A table that maps, Pegasus style keys to appropriate classes implementing the CondorStyle
     * interface
     */
     ...
     *     instantiation of the implementation.
     */
    public CondorStyle loadInstance(SiteCatalogEntry site) throws CondorStyleFactoryException {
        ...
        String defaultStyle =
                site.getSiteHandle().equalsIgnoreCase("local")
                        ?
                        // jobs scheduled on local site have
                        // default style as condor
                        Pegasus.CONDOR_STYLE
        ...
        String style =
                pegasusProfiles.containsKey(key) ? (String) pegasusProfiles.get(key) : defaultStyle;
     ...
     */
    private CondorStyle loadInstance(PegasusBag bag, String className)
        ...
        try {
            ...
            throw new CondorStyleFactoryException("Instantiating Condor Style ", className, e);
        }
