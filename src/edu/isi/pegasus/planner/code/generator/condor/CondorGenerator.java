...
public class CondorGenerator extends Abstract {
    ...
    /**
     * The logical key with which to query the transformation catalog for the
 ...
 the key of the class that implements the pool interface the user has
 asked at runtime.
     */
...
//       sb.append( this.mDAGManKnobs );
    ...
    /**
     * Returns the key of Condor log file in a tmp directory that is created
...
//        printDagString(job.dagmanVariables.toString(jobName));
     ...
     *
     * @param deprecated   the deprecated property that needs to be
     *                             replaced.
     * @param replacement          the new property that should be used.
     */
    private void logDeprecatedPropertyWarning( String prefix,
                                               String deprecated,
                                               String replacement){
        StringBuilder sb = new StringBuilder();
        sb.append( prefix ).append( " " ).append( deprecated ).
           append( " . Replacing with " ).append( replacement );
