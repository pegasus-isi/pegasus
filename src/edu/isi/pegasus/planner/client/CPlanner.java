...
public class CPlanner extends Executable {
    ...
    public Collection<File> executeCommand(PlannerOptions options) {
        ...
        if (options.getOutputMap() != null && !options.partOfDeferredRun()) {
            throw new RuntimeException(
                    "output map option is only for internal use for hierarchal workflows");
        }

        // try to get hold of the vds properties
        // set in the jvm that user specified at command line
    ...
    public PlannerOptions parseCommandLineArguments(String[] args, boolean sanitizePath) {
        ...
        // we default to inplace cleanup unless overridden on command line
     ...
     * The name is generated by default from the flow ID, unless a basename prefix is specified at
    ...
    public void printLongVersion() {
        ...
        text.append("\n $Id$ ")
                ...
                .append(
                        "\n"
                            + "                       the directory specified is associated with"
                ...
                .append(
                        "\n"
                            + " 2 an error occurred while loading a specific module implementation"
                            + " at runtime")
    ...
    private String determineRootWorkflowUUID(
        ...
        if (options.partOfDeferredRun()) {
            ...
            // we have to retrieve from properties
