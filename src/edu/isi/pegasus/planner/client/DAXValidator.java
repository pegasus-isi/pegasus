...
public class DAXValidator extends DefaultHandler 
{
    ...
    throws Exception
  {
    ...
    set( "http://apache.org/xml/features/validation/schema/ignore-xsi-type-until-elemdecl", true );
    ...
    if ( schemaLocation != null ) {
      prop( "http://apache.org/xml/properties/schema/external-schemaLocation", 
