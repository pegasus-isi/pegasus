 ...
 */
{
  ...
  fprintf(out, "%*s<cpu count=\"%hu\" online=\"%hu\" speed=\"%lu\""
          ...
          ptr->cpu_count, ptr->cpu_online, ptr->megahertz,
          ptr->cpu_type, ptr->brand_id, ptr->model_name);
