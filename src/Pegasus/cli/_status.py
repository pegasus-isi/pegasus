"""pegasus status — retrieve status of a given workflow."""
...
@click.command("status", options_metavar="<options>")
@click.pass_context
@click.option(
    "--long",
    "-l",
...
def status(ctx, long, jsonrv, watch, dirs, legend, noqueue, debug, submit_dir):
    """Retrieve status of a given workflow."""
