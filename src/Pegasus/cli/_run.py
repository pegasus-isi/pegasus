"""pegasus run — submit a workflow for execution."""
...
def get_grid_proxy_info(globus_location):
    """Locate grid-proxy-info and check if it is executable."""
...
def run(ctx, grid=False, json=False, verbose=0, submit_dir=None):
