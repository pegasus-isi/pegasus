...
local_site.add_directories(
    ...
    Directory(directory_type=Directory.SHARED_SCRATCH, path=TOP_DIR / "work/scratch")
        .add_file_servers(FileServer(url="file://" + str(TOP_DIR / "work/scratch"), operation_type=Operation.ALL))
)
