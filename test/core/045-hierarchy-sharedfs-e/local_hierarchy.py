...
""".format(run_id=RUN_ID, work_dir=str(WORK_DIR), cluster_pegasus_home="/usr")
...
pre_preprocess_job = (
    Job("pre-preprocess", namespace="diamond", version="4.0")
    .add_args("-a", "post-analyze", "-T10", "-i", finput, "-o", fa)
    .add_inputs(finput)
