...
ccg_site.add_directories(
    Directory(
        Directory.SHARED_SCRATCH, "/scitech/shared/scratch-90-days/CCG/scratch"
    ).add_file_servers(
        FileServer(
            "gsiftp://obelix.isi.edu/scitech/shared/scratch-90-days/CCG/scratch",
            Operation.ALL,
        )
    ),
    Directory(
        Directory.LOCAL_STORAGE, "/scitech/shared/scratch-90-days/CCG/outputs"
    ).add_file_servers(
        FileServer(
            "gsiftp://obelix.isi.edu/scitech/shared/scratch-90-days/CCG/outputs",
            Operation.ALL,
        )
    ),
)
