...
with open("/scitech/shared/scratch-90-days/043-integrity-bypass-staging-b/f.a", "wb+") as f:
...
rc = ReplicaCatalog().add_replica(
    LOCAL,
    fa,
    "scp://bamboo@bamboo.isi.edu/scitech/shared/scratch-90-days/043-integrity-bypass-staging-b/" + fa.lfn,
