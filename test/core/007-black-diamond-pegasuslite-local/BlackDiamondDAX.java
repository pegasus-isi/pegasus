...
public class BlackDiamondDAX {
    ...
    private static ADAG Diamond(String pegasus_location) throws Exception {
        ...
        preprocess.setArchitecture(Executable.ARCH.X86_64).setOS(Executable.OS.LINUX).setOSRelease("deb").setOSVersion("9");   
        ...
        findrange.setArchitecture(Executable.ARCH.X86_64).setOS(Executable.OS.LINUX).setOSRelease("deb").setOSVersion("9");   
        ...
        analyze.setArchitecture(Executable.ARCH.X86_64).setOS(Executable.OS.LINUX).setOSRelease("deb").setOSVersion("9");
