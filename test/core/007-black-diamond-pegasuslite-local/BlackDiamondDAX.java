...
public class BlackDiamondDAX {
    ...
    private static ADAG Diamond(String pegasus_location) throws Exception {
        ...
        preprocess.setArchitecture(Executable.ARCH.X86_64).setOS(Executable.OS.LINUX).setOSRelease("rhel").setOSVersion("8");   
        ...
        findrange.setArchitecture(Executable.ARCH.X86_64).setOS(Executable.OS.LINUX).setOSRelease("rhel").setOSVersion("8");   
        ...
        analyze.setArchitecture(Executable.ARCH.X86_64).setOS(Executable.OS.LINUX).setOSRelease("rhel").setOSVersion("8");
