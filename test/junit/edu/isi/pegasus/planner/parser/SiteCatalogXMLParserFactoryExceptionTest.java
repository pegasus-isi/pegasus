...
/** @author Rajiv Mayani */
public class SiteCatalogXMLParserFactoryExceptionTest {
    ...
    */
    ...
    public void testDefaultNameConstant() {
        assertThat(
                ...
                SiteCatalogXMLParserFactoryException.DEFAULT_NAME,
                is("DAX Callback"));
    }
    ...
    public void testMessageOnlyConstructorUsesDefaultClassname() throws Exception {
        SiteCatalogXMLParserFactoryException exception =
                new SiteCatalogXMLParserFactoryException("message");
        ...
        assertThat(
                ...
                is(SiteCatalogXMLParserFactoryException.DEFAULT_NAME));
    }
    ...
    public void testMessageAndCauseConstructorUsesDefaultClassname() throws Exception {
        ...
        SiteCatalogXMLParserFactoryException exception =
                new SiteCatalogXMLParserFactoryException("message", cause);
    ...
    public void testExplicitClassnameAndCauseConstructorPreservesValues() throws Exception {
        ...
        SiteCatalogXMLParserFactoryException exception =
                new SiteCatalogXMLParserFactoryException("message", "custom", cause);
    ...
    private String getClassname(SiteCatalogXMLParserFactoryException exception) throws Exception {
