...
public class TransformationCatalogYAMLParserTest {
    ...
    public TransformationCatalogYAMLParserTest() {
        ...
        mLogger.logEventStart(
                "test.edu.isi.pegasus.planner.parser.TransformationCatalogYamlParser",
                "setup",
                "0");
    }
    ...
    public void testSingleProfileParsing() {
        String input = "APP_HOME: \"/tmp/myscratch\"\n";
    ...
    public void testProfileWithDifferentNamespaceParsing() {
        ...
        assertEquals(
                "Number of Env Profiles", 2, profiles.getProfiles(Profiles.NAMESPACES.env).size());
        assertEquals(
                "Number of Pegasus Profiles",
                1,
                profiles.getProfiles(Profiles.NAMESPACES.pegasus).size());
    ...
    private void assertProfile(Profile expected, Profile actual) {
        assertEquals(
                "Namespace mismatch", expected.getProfileNamespace(), actual.getProfileNamespace());
