...
public class PlannerMetricsTest {
    ...
    public void testDefaultUsesPMCIsFalse() {
        PlannerMetrics pm = new PlannerMetrics();
        assertThat(pm.usesPMC(), is(false));
    }
    ...
    @Test
    public void testDefaultWFAPIIsDefaultDaxApi() {
        PlannerMetrics pm = new PlannerMetrics();
        assertThat(pm.getWFAPI(), is(Metadata.DEFAULT_DAX_API));
    }
    ...
    @Test
    public void testSetPlannerOptionsFromPlannerOptionsUsesOriginalArgString() {
        PlannerMetrics pm = new PlannerMetrics();
        PlannerOptions options = new PlannerOptions();
        options.setOriginalArgString(new String[] {"--dax", "test.dax", "--sites", "local"});

        pm.setPlannerOptions(options);
    ...
    @Test
    public void testSetApplicationMetricsFromPegasusPropertiesUsesDefaultName() {
        PlannerMetrics pm = new PlannerMetrics();
        PegasusProperties props = PegasusProperties.nonSingletonInstance();
        props.setProperty(PegasusProperties.PEGASUS_APP_METRICS_PREFIX + ".owner", "isi");

        pm.setApplicationMetrics(props, "planner-app");

        assertThat(pm.getApplicationMetrics(), notNullValue());
        assertThat(pm.getApplicationMetrics().getProperty("name"), is("planner-app"));
        assertThat(pm.getApplicationMetrics().getProperty("owner"), is("isi"));
    }

    @Test
    public void testSetApplicationMetricsFromPegasusPropertiesPrefersConfiguredName() {
        PlannerMetrics pm = new PlannerMetrics();
        PegasusProperties props = PegasusProperties.nonSingletonInstance();
        props.setProperty(PegasusProperties.PEGASUS_APP_METRICS_PREFIX, "configured-app");
        props.setProperty(PegasusProperties.PEGASUS_APP_METRICS_PREFIX + ".owner", "isi");

        pm.setApplicationMetrics(props, "fallback-app");

        assertThat(pm.getApplicationMetrics(), notNullValue());
        assertThat(pm.getApplicationMetrics().getProperty("name"), is("configured-app"));
        assertThat(pm.getApplicationMetrics().getProperty("owner"), is("isi"));
    }

    @Test
    public void testSetApplicationMetricsFromPegasusPropertiesWithNoNameLeavesMetricsUnset() {
        PlannerMetrics pm = new PlannerMetrics();
        PegasusProperties props = PegasusProperties.nonSingletonInstance();
        props.setProperty(PegasusProperties.PEGASUS_APP_METRICS_PREFIX + ".owner", "isi");

        pm.setApplicationMetrics(props, null);

        assertThat(pm.getApplicationMetrics(), nullValue());
    }
    ...
    public void testCloneProducesEqualState() {
        ...
        assertThat(clone.usesPMC(), is(true));
    ...
    @Test
    public void testCloneRetainsSameWorkflowMetricsReference() {
        PlannerMetrics pm = new PlannerMetrics();
        WorkflowMetrics wm = new WorkflowMetrics();
        wm.setLabel("wf");
        pm.setWorkflowMetrics(wm);
        ...
        PlannerMetrics clone = (PlannerMetrics) pm.clone();
        clone.getWorkflowMetrics().setLabel("changed");

        assertThat(clone.getWorkflowMetrics(), sameInstance(wm));
        assertThat(pm.getWorkflowMetrics().getLabel(), is("changed"));
    }
}
