...
public class DirectoryTest {
    ...
    public void testDirectorySerialization()throws IOException{
        ...
        dir.setInternalMountPoint( new InternalMountPoint("/mount/workflows/scratch", "122GB", "1GB"));
    ...
    public void testDirectoryDeserialization() throws IOException{
        ...
        assertEquals(new InternalMountPoint("/mount/workflows/scratch", "122GB", "1GB").toString(), dir.getInternalMountPoint().toString());
