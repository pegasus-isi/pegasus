...
public class FactoryExceptionTest {
    ...
    @Test
    public void testConstructor_messageAndNullClassnamePreservesNull() {
        FactoryException ex = new FactoryException("msg", (String) null);
        assertThat(ex.getClassname(), is(nullValue()));
    }

    @Test
    public void testConstructor_messageNullClassnameAndCausePreservesNull() {
        FactoryException ex = new FactoryException("msg", null, new RuntimeException("root cause"));
        assertThat(ex.getClassname(), is(nullValue()));
        assertThat(ex.getCause().getMessage(), is("root cause"));
    }

    @Test
    public void testDeclaresProtectedStringClassnameField() throws Exception {
        Field field = FactoryException.class.getDeclaredField("mClassname");
        assertThat(field.getType(), is(String.class));
