...
public class EscapeTest {
    ...
    public void testEscape_nullReturnsNull() {
        Escape e = new Escape();
        assertThat(e.escape(null), is(nullValue()));
    }
    ...
    public void testUnescape_nullReturnsNull() {
        Escape e = new Escape();
        assertThat(e.unescape(null), is(nullValue()));
    }
    ...
    public void testRoundTrip_null() {
        Escape e = new Escape();
        assertThat(e.unescape(e.escape(null)), is(nullValue()));
    }
    ...
    @Test
    public void testCustomConstructorWithEmptyEscapableStillEscapesEscapeCharacter() {
        Escape e = new Escape("", '#');
        assertThat(e.escape("a#b"), is("a##b"));
    }

    @Test
    public void testCustomUnescapeReEmitsEscapeForNonEscapableCharacter() {
        Escape e = new Escape("|;", '|');
        assertThat(e.unescape("|x"), is("|x"));
    }

    @Test
    public void testMainWithNoArgumentsDoesNotThrow() {
        assertDoesNotThrow(() -> Escape.main(new String[0]));
    }

    @Test
    public void testDeclaresExpectedPrivateFields() throws Exception {
        Field escapeField = Escape.class.getDeclaredField("m_escape");
        Field escapableField = Escape.class.getDeclaredField("m_escapable");
        assertThat(escapeField.getType(), is(char.class));
        assertThat(escapableField.getType(), is(String.class));
    }
}
