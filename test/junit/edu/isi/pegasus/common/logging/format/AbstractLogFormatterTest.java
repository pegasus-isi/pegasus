...
public class AbstractLogFormatterTest {
    ...
    public void testAbstractLogFormatterIsAbstract() {
        assertTrue(Modifier.isAbstract(AbstractLogFormatter.class.getModifiers()));
    }
    ...
    @Test
    public void testGetEventNameReturnsTopOfStack() {
        formatter.addEvent("event.first", "workflow", "wf-001");
        assertThat(formatter.getEventName(), is("event.first"));
    }
    ...
    public void testNestedEventsStackOrder() {
        ...
        assertThat(formatter.getEventName(), is("event.inner"));

        formatter.popEvent();
        assertThat(formatter.getEventName(), is("event.outer"));
    }
