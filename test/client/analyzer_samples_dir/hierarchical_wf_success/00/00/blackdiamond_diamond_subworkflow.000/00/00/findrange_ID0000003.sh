...
pegasus-kickstart  -n findrange -N ID0000003 -R condorpool  -s f.c2=f.c2 -L inner -T 2023-03-04T01:00:54-08:00 ./findrange -a findrange -T 20 -i f.b2 -o f.c2
job_ec=$?
