...
.. glossary::
   ...
   Abstract Workflow
      ...
      Pegasus location of the files (Replica Catalog), executables
   ...
   Deferred Planning
      ...
      to run. Deferred planning only applies to pegasusWorkflow jobs in the
   ...
   Executable Workflow
      ...
      represented by physical filenames, transformations represented by
      paths to executables and in which sites or hosts have been selected
   ...
   Physical File Name
      The physical filename (URL) of the LFN. The physical filename is usually
      associated with a "site" attribute in Pegasus catalogs, to tell Pegasus
      what site a file pointed to by a PFN resides on.
   ...
   Replica Catalog
      ...
      Pegasus uses this catalog to discover location of datasets referred
