...
There are two main ways of generating the abstract workflow
...
1.  **Replica Catalog**
    ...
    In the example Abstract Workflow above, that would be file *f.a*.

    You can use the Python Workflow API to generate a replica catalog. By
...
2.  **Transformation Catalog**
    ...
    jobs are launched. In the example Abstract Workflow above, the transformation
...
3.  **Site Catalog**
    ...
    * **condorpool**
    ...
    You can use the Python Workflow API to generate a site catalog. By
