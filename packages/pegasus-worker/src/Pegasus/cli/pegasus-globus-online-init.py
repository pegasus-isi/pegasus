...
parser = ArgumentParser(description="Initialize Globus OAuth Tokens - SDK Version {}".format(globus_sdk.__version__))
parser.add_argument(
    "-p",
    "--permanent",
    action="store_true",
...
print(json.dumps(token_response.by_resource_server, indent=2))
