...
class InterpolationLoopError(InterpolationError):
    ...
    def __init__(self, option):
        InterpolationError.__init__(
            self, f'interpolation loop detected in value "{option}".'
        )
...
class MissingInterpolationOption(InterpolationError):
    ...
    def __init__(self, option):
        InterpolationError.__init__(
            self, f'missing option "{option}" in interpolation.'
        )
...
class InterpolationEngine:
    ...
    def interpolate(self, key, value):
        ...
        return recursive_interpolate(key, value, self.section, {})
...
class Section(dict):
    ...
    def istrue(self, key):
        ...
        warn(
            "use of ``istrue`` is deprecated. Use ``as_bool`` method instead.",
            DeprecationWarning,
        )
...
class ConfigObj(Section):
    ...
    def _parse(self, infile):
        ...
        while cur_index < maxline:
            ...
            if mat is None:
                ...
                # or a section marker
                self._handle_error(
                    'Invalid line at line "%s".', ParseError, infile, cur_index
                )
            else:
                # is a keyword value
        ...
        if not isinstance(configspec, ConfigObj):
            try:
                configspec = ConfigObj(
                    configspec, raise_errors=True, file_error=True, list_values=False
                )
    ...
    def _set_configspec_value(self, configspec, section):
        ...
        for entry in configspec.scalars:
            ...
            section._configspec_inline_comments[entry] = configspec.inline_comments[
                entry
            ]
        ...
        for entry in configspec.sections:
            ...
            section._cs_section_inline_comments[entry] = configspec.inline_comments[
                entry
            ]
    ...
    def _handle_repeat(self, section, configspec):
        ...
        try:
            ...
            section_keys = [
                entry for entry in configspec if isinstance(configspec[entry], dict)
            ]
            scalar_keys = [
                entry for entry in configspec if not isinstance(configspec[entry], dict)
            ]
    ...
    def validate(self, validator, preserve_errors=False, copy=False, section=None):
        ...
        for entry in order:
            ...
            if (entry not in section.scalars) or (entry in section.defaults):
                ...
                if copy and entry not in section.scalars:
                    # copy comments
                    section.comments[entry] = section._configspec_comments.get(
                        entry, []
                    )
        ...
        for entry in section.sections:
            ...
            if copy:
                ...
                section.inline_comments[entry] = section._cs_section_inline_comments[
                    entry
                ]
            check = self.validate(
                validator,
