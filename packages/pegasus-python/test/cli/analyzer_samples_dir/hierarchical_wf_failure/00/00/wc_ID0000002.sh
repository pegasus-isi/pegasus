...
pegasus-kickstart  -n wc -N ID0000002 -o count.txt -R condorpool  -s count.txt=count.txt -L hierarchical-workflow -T 2023-03-04T11:55:58-08:00 /usr/bin/wc -l f.d
job_ec=$?
