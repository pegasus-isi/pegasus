...
class Properties:
    ...
    _props = (
        ...
        "pegasus.container.arguments",
        "pegasus.container.launcher",
        "pegasus.container.launcher.arguments",
    ...
    @classmethod
    def load(cls, file: Union[str, Path, TextIO]) -> "Properties":
        ...
        if isinstance(file, (str, Path)):
            ...
            raise TypeError(
                "invalid file: {}; file must be of type str, Path, or file like object".format(
                    file
                )
            )
