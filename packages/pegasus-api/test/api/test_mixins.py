    ...
    def test_add_pegasus_profile(self, obj):
        assert id(
            obj.add_pegasus_profile(
                ...
                container_launcher="/usr/bin/srun",
        ...
        assert dict(obj.profiles) == {
            "pegasus": {
                ...
                "container.launcher": "/usr/bin/srun",
                "container.launcher.arguments": "--kill-on-bad-exit",
                "label": "nodeLabel",
                "pegasus_lite_env_source": "/path",
                "SSH_PRIVATE_KEY": "/path",
