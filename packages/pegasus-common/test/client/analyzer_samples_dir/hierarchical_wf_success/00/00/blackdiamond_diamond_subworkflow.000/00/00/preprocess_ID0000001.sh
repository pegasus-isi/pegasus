...
pegasus-kickstart  -n preprocess -N ID0000001 -R condorpool  -s f.b2=f.b2 -s f.b1=f.b1 -L inner -T 2023-03-04T01:00:54-08:00 ./preprocess -a preprocess -T 20 -i pegasus.html -o f.b1 f.b2
job_ec=$?
