...
pegasus-kickstart  -n curl -N ID0000001 -R condorpool  -s pegasus.html=pegasus.html -L hierarchical-workflow -T 2023-03-04T11:55:58-08:00 /usr/bin/curl -o pegasus.html http://pegasus.isi.edu
job_ec=$?
